...
type UnauthenticatedDetails struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Types that are assignable to Reason:
	//
	//	*UnauthenticatedDetails_UserDeleted
	Reason isUnauthenticatedDetails_Reason `protobuf_oneof:"reason"`
}

func (x *UnauthenticatedDetails) Reset() {
	*x = UnauthenticatedDetails{}
	if protoimpl.UnsafeEnabled {
...
func (x *UnauthenticatedDetails) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnauthenticatedDetails) ProtoMessage() {}

func (x *UnauthenticatedDetails) ProtoReflect() protoreflect.Message {
	mi := &file_gitpod_v1_error_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UnauthenticatedDetails.ProtoReflect.Descriptor instead.
func (*UnauthenticatedDetails) Descriptor() ([]byte, []int) {
	return file_gitpod_v1_error_proto_rawDescGZIP(), []int{12}
}

func (m *UnauthenticatedDetails) GetReason() isUnauthenticatedDetails_Reason {
	if m != nil {
		return m.Reason
	}
	return nil
...
func (x *UnauthenticatedDetails) GetUserDeleted() *UserDeletedError {
	if x, ok := x.GetReason().(*UnauthenticatedDetails_UserDeleted); ok {
		return x.UserDeleted
	}
	return nil
}

type isUnauthenticatedDetails_Reason interface {
	isUnauthenticatedDetails_Reason()
}

type UnauthenticatedDetails_UserDeleted struct {
	UserDeleted *UserDeletedError `protobuf:"bytes,1,opt,name=user_deleted,json=userDeleted,proto3,oneof"`
}

func (*UnauthenticatedDetails_UserDeleted) isUnauthenticatedDetails_Reason() {}
...
var file_gitpod_v1_error_proto_rawDesc = []byte{
	...
	,
...
var file_gitpod_v1_error_proto_goTypes = []interface{}{
	...
	(*UnauthenticatedDetails)(nil),             // 12: gitpod.v1.UnauthenticatedDetails
...
var file_gitpod_v1_error_proto_depIdxs = []int32{
	...
	13, // 10: gitpod.v1.UnauthenticatedDetails.user_deleted:type_name -> gitpod.v1.UserDeletedError
...
func file_gitpod_v1_error_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_gitpod_v1_error_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UnauthenticatedDetails); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_gitpod_v1_error_proto_msgTypes[12].OneofWrappers = []interface{}{
		(*UnauthenticatedDetails_UserDeleted)(nil),
	}
	type x struct{}
